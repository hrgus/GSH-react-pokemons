...
class TeamContainer extends Component {
  ...
  mappedTeam = () =>
    this.props.team.map((pokemon) => <TeamPokemon pokemon={pokemon} />);
  noTeamHtml = () => (
    <>
      <h1>You have no Pokemon on your team. </h1>
      <img
        alt="surprised pikachu"
        src="https://media.tenor.com/images/7c355668e41f8cf511fe30c8483379d0/tenor.gif"
      />
    </>
  );
  ...
  render() {
    return (
      <div id="team-container">
        ...
        <h3>
          YOU HAVE {this.state.timeLeft} SECONDS LEFT BEFORE YOUR POKEMON RUN!
        </h3>
